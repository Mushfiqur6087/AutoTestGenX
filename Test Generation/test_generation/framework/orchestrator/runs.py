...
Layout under ``outputs/.checkpoints/``:
    test_generation.sqlite       single shared LangGraph checkpoint DB
...
CHECKPOINT_DIR = Path("agent_logs") / ".checkpoints"
CHECKPOINT_DB = CHECKPOINT_DIR / "test_generation.sqlite"
