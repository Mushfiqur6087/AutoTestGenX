...
# -*- coding: utf-8 -*-
"""
Test Case Generation Experiment Runner
==============================
  ...
  results/
    {website}/
      {model}/
        ...
        agent/       <- test-cases.json, structural-model.json, workflows.json, ...
...
from test_case_generation.experiments.config import MODELS, SPECS, ZERO_SHOT_PROMPT_PATH, RESULTS_DIR
from test_case_generation.experiments.reporting import write_summary
...
def run_agent(website: str, model_key: str, model_str: str, api_key: str,
    ...
    dest.mkdir(parents=True, exist_ok=True)
    cmd = [
        sys.executable, "-m", "test_case_generation",
        "--generate",
...
async def main():
    parser = argparse.ArgumentParser(description="Test Case Generation Experiment Runner")
    ...
    print()
    log("Test Case Generation Experiment Runner", "HEAD")
